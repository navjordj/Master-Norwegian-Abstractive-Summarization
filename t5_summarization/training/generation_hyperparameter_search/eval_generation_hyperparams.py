...
configs = [greedy_config, beam_config, beam_no_stopping_config, beam_rep_penalty_1_2_config, beam_rep_penalty_2_config, beam_no_ngram_2, beam_no_ngram_4, beam_no_ngram_24, sample_config, sample_temperature_config, top_k_config, top_p_config]
...
for config in tqdm.tqdm(configs):
    print(config)
    pipe = pipeline("summarization", model=model, tokenizer=tokenizer, batch_size=2, device=device, **config)
